...
![Image of AWS showing name, OS image, and Instance type](web-server-01.png)
![Image of AWS showing key pair, Network Settings, Storage](web-server-02.png)
...
![Image of AWS showing the inbound rules of the security group the VM belongs to](inbound-rules.png)
...
![Image of AWS showing bucket name, region, and namespace](bucket-creation-01.png)
![Image of AWS showing public access settings](bucket-creation-02.png)
